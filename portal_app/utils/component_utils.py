...
class UIComponent():
    ...
    def button_fac(self, title, id, icon=None, **kwargs):
        if icon:
            return fac.AntdButton(title, id=id,
                                  icon=fac.AntdIcon(icon=icon,**kwargs)
                                  )
        else:
            return fac.AntdButton(title, id, **kwargs)

    def button_dmc(self, title, id, className, icon=None, style={}, n_clicks=0):
        if icon:
            return dmc.Button(title, id=id,
            ...
            return dmc.Button(title, id, className=className, style=style, n_clicks=n_clicks)
